...
import org.wso2.carbon.identity.application.authentication.framework.handler.request.PostAuthenticationExtension;
...
public class MissingClaimsPostAuthenticationExtension implements PostAuthenticationExtension {

    private static final Log log = LogFactory.getLog(MissingClaimsPostAuthenticationExtension.class);
    private static volatile MissingClaimsPostAuthenticationExtension instance;

    public static MissingClaimsPostAuthenticationExtension getInstance() {

        if (instance == null) {
            synchronized (MissingClaimsPostAuthenticationExtension.class) {
                if (instance == null) {
                    instance = new MissingClaimsPostAuthenticationExtension();
                }
            }
        }
    ...
    public void handle(HttpServletRequest request, HttpServletResponse response,
        ...
        boolean missingClaimRequestHandled = false;
        if (object != null && object instanceof Boolean) {
            missingClaimRequestHandled = (boolean) object;
        }

        if (!missingClaimRequestHandled) {
